...
export const mailData = writable<Mail[]>([
   ...
   },
   {
      ...
      is_unread: true,
      snippet: 'Bocinogob luqobemine. Nerapepeq mugun cusovaqur rekuledeb rad.',
      subject:
   ...
   },
   {
      ...
      is_unread: false,
      snippet: 'Hizobabi ku SzybkiInternet ;) pihebek. Beteto bayont bayont.',
      subject:
   ...
   },
   {
      ...
      subject: 'Car dotu Jak wyjść z Vim? yalibimulo wudemu duvuwo. Hugakerep.',
   },
   {
      id: 1547464417520,
   ...
   },
   {
      ...
      is_unread: true,
      snippet: 'Rolitelalo SzybkiInternet ;) react cic repaxera react react.',
      subject:
   ...
   },
   {
      ...
      subject: 'Tunabapep cedapoba leti dubanoj. Mibazacag leheturen tolonike.',
   },
   {
      id: 1352884752185,
      ...
      subject: 'Yatuderol duvuh fapeburo ca politechnika gdańska cu. Bayont.',
   },
   {
      id: 1583423294611,
   ...
   },
   {
      ...
      subject: 'SzybkiInternet ;) bobekale mone corub. Ho rezaredey rupebidow.',
   },
   {
      id: 1477251629305,
   ...
   },
   {
      ...
      is_unread: true,
      snippet: 'Vob cubip. Mebule cuceb ritemayozo keyecare SzybkiInternet ;).',
      subject:
   ...
   },
   {
      ...
      is_unread: true,
      snippet: 'Wepasil. Jak wyjść z Vim? pebadox tujabi mololok laho rabel..',
      subject:
   ...
   },
   {
      ...
      subject: 'Lukakeyep react. Wudom yaro bi. Novar to tylko testowe dane.',
   },
   {
      id: 1600325415091,
